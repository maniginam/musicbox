...
(describe "Musicbox"
  ...
  (it "calcs coordinates a pin"
    (should= [1.0 0.0 -1] (sut/calc-coordinates-of-a-single-pin {:height 0 :radius 1 :num-teeth 16 :notes []} 1 0 0))
    (should= [7.16197243913529 0.0 -1] (sut/calc-coordinates-of-a-single-pin {:height 17 :radius (sut/calc-radius 45) :num-teeth 16 :notes c-scale} 1 0 0)))
